  ...
  function injectNavBar() {
    ...
    slot.innerHTML = `
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:6px;line-height:1.3;padding:0 2px;gap:6px;">
        <div style="display:flex;gap:4px;">
          <button id="nav-back" aria-label="뒤로가기" title="뒤로가기" style="background:#6b7280;color:white;border:none;border-radius:8px;padding:0 10px;height:24px;font-size:11px;font-weight:600;cursor:pointer;box-shadow:0 1px 2px rgba(0,0,0,0.08);display:inline-flex;align-items:center;justify-content:center;gap:2px;line-height:1;white-space:nowrap;">← 뒤로</button>
          <button id="nav-forward" aria-label="앞으로가기" title="앞으로가기" style="background:#6b7280;color:white;border:none;border-radius:8px;padding:0 10px;height:24px;font-size:11px;font-weight:600;cursor:pointer;box-shadow:0 1px 2px rgba(0,0,0,0.08);display:inline-flex;align-items:center;justify-content:center;gap:2px;line-height:1;white-space:nowrap;">앞으로 →</button>
        </div>
